...
//Складывая строчный тип данных с любым другим типом данных - js приводит всё к строковому типу данных
...
}//чтобы привести к числу - нужно добавить унарный плюс перед data.value
...
function t12() {
	let data1 = document.querySelector('.i-12-1'),
		 data2 = document.querySelector('.i-12-2');
	document.querySelector('.out-12').textContent = 'Hello ' + data1.value + " " + data2.value;
}
...
function t16() {
	let data1 = document.querySelector('.i-16-1').value,
		 data2 = document.querySelector('.i-16-2').value;
	document.querySelector('.out-16').textContent = data1 + data2;
}
...
function t19() {
	let data1 = document.querySelector('.i-19-1').value,
		 data2 = document.querySelector('.i-19-2').value;
	document.querySelector('.out-19').textContent = +data1 + +data2
}
