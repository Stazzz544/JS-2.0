...
function t1() {
	...
	xhttp.open('GET', `${link}?${auth}&${action}`);
	xhttp.send();
...
function t2() {
	...
	xhttp.open('GET', `${link}?${auth}&${action}&${myName}`)
	xhttp.send();
	xhttp.onreadystatechange = function () {
		if (this.readyState == 4 && this.status == 200) {
			out.innerHTML = this.responseText;
...
let xhttp = new XMLHttpRequest;
	...
	xhttp.open('GET', `${link}?${auth}&${action}&${num1}&${num2}`)
	xhttp.send();
	xhttp.onreadystatechange = function () {
		if (this.readyState == 4 && this.status == 200) {
			out.innerHTML = this.responseText;
...
function t8() {
	...
	let xhttp = new XMLHttpRequest();
	xhttp.open("GET", `${link}?${auth}&${action}&${year}`);
	xhttp.send();
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			out.innerHTML = this.responseText;
...
function t9() {
	...
	let xhttp = new XMLHttpRequest();
	xhttp.open("GET", `${link}?${auth}&${action}&${d}&${m}&${y}`); 
	xhttp.send();
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200){
			out.innerHTML = this.responseText;
...
function t10() {
	...
	let xhttp = new XMLHttpRequest();
	xhttp.open('POST', `${link}?${auth}&${action}`);
	xhttp.send();
...
function t11() {
	...
	let xhttp = new XMLHttpRequest();
	xhttp.open("POST", `${link}?${auth}&${action}&${name}`);
	xhttp.send();
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			out.innerHTML = this.responseText;
...
function t12() {
	...
	let xhttp = new XMLHttpRequest();
	xhttp.open("POST", `${link}?${auth}&${action}&${num1}&${num2}`);
	xhttp.send();
	xhttp.onreadystatechange = function() {
		if(this.readyState == 4 && this.status == 200) {
			out.innerHTML = this.responseText;
...
function t17() {
	...
	let xhttp = new XMLHttpRequest();
	xhttp.open('POST', `${link}?${auth}&${action}&${year}`);
	xhttp.send();
	xhttp.onreadystatechange = function () {
		if (this.readyState == 4 && this.status == 200) {
			out.innerHTML = this.responseText;
...
function t18() {
	...
	let xhttp = new XMLHttpRequest();
	xhttp.open('POST', `${link}?${auth}&${action}&${m}&${d}&${y}`);
	xhttp.send();
	xhttp.onreadystatechange = function () {
		if (this.readyState == 4 && this.status == 200) {
			out.innerHTML = this.responseText;
