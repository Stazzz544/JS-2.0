...
function f1() {
	const out = document.querySelector('.out-1').textContent = 1;
}
...
function f2() {
	const out = document.querySelector('.out-2').textContent = 2;
}
...
function f3() {
	const out = document.querySelector('.out-3').textContent = 3;
}
...
function f6() {
	const inpValue = document.querySelector('.i-6').value;
	document.querySelector('.out-6').textContent = inpValue;
}
...
function f7() {
	const inpValue = document.querySelector('.i-7').value;
			outLength = document.querySelector('.out-72')

	document.querySelector('.out-71').textContent = inpValue;

	if (inpValue.length >= 6) {
		outLength.textContent = 1;
	} else {
...
function f10() {
	const inpVal= document.querySelector('.i-10').value,
			out = document.querySelector('.out-10');
	out.style.background = inpVal;
}
...
function f11() {
	const inp1Value = document.querySelector('.i-111').value;
	document.querySelector('.i-112').value = inp1Value;
}
...
function f13() {
	const range = document.querySelector('.i-13').value;
...
function f15() {
	const inpVal = document.querySelector('.i-15').value;
	document.querySelector('.t-15').value = inpVal;
	document.querySelector('.out-15').textContent = inpVal;
}
...
function f16() {
	...
	const slc = document.querySelector('.s-16').value;
	document.querySelector('.out-16').textContent = slc;
}
...
function f17() {
	const slc = document.querySelector('.s-17').value;
	document.querySelector('.out-17').textContent = slc;
}
...
function f18() {
	const slc = document.querySelector('.s-18').value;
	document.querySelector('.i-18').value = slc;
}
...
function f19() {
	const text = document.querySelector('.out-19').textContent;
...
function f20() {
	const slc1Val = document.querySelector('.s-201').value;
	document.querySelector('.s-202').value = slc1Val;
}
