...
function f1() {
	const elem = document.querySelector('.out-1');
...
function f2() {
	const elem = document.querySelector('.out-2');
...
function f3() {
	const elem = document.querySelector('.out-3');
...
function f4() {
	const elem = document.querySelector('.out-4');
...
function f5() {
	...
	if (elem.classList.contains('bg-orange')) {
		out.innerHTML = true;
	} else {
		out.innerHTML = false;
	}
...
function f6() {
	const elem = document.querySelectorAll('.p-6');
	document.querySelector('.out-6').innerHTML = elem.length;
}
...
function f7() {
    //внутри цикла blocks7[i].classList....
	 const elem = document.querySelectorAll('.out-7');
	 for (let i = 0; i < elem.length; i++) {
		 elem[i].classList.add('bg-orange');
	 }
}
...
function f8() {
	...
	const elem = document.querySelectorAll('.out-8');
	for (let i = 0; i < elem.length; i++) {
		elem[i].classList.toggle('bg-orange');
	}
}
...
function f9() {
	...
	const elem = document.querySelectorAll('.out-9');
	for (let i = 0; i < elem.length; i++) {
...
function f13_1() {
   document.querySelector('.out-13-1').innerHTML += thisinnerHTML;
}
...
function f18() {
	const elem = document.querySelector('.p-18'),
			atr = elem.getAttribute('data-b');
	document.querySelector('.out-18').innerHTML = atr;
}
...
function f19() {
	const elem = document.querySelectorAll('.p-19');
	let out = '';
	for(let i = 0; i < elem.length; i++) {
		out += elem[i].getAttribute('data-b');
		out += ' ';
	}
...
function f20() {
	const elem = document.querySelector('.out-20');
