...
function f1() {
   let out = '',
		 newArrElem = document.querySelector('.i-1').value;
		 d1.push(newArrElem);
...
function f6() {
	...
	let maxInd = d6.length;
	d6[maxInd] = document.querySelector('.i-6').value;
   showArr('.out-6', d6);
...
function f8() {
	...
	let newArr = [];
	newArr[0] = document.querySelector('.i-8').value;
...
function f17() {
	...
	function myConcat (oldArr, newArr) {
...
function f18() {
	const inp = document.querySelector('.i-18').value;
...
function f20() {
	newArr = d20.join('');
	document.querySelector('.out-20').innerHTML = newArr;
}
